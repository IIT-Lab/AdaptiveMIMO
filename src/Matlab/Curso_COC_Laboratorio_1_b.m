...
if ModOrd==2
    ...
    ber_teor=qfunc(sqrt(2*SNR_sim));
elseif ModOrd==4
    ber_teor=qfunc(sqrt(SNR));
    ber_teor_sim=qfunc(sqrt(SNR));
elseif ModOrd==16
    ber_teor=3/4*qfunc(sqrt(SNR/5));
    ber_teor=3/4*qfunc(sqrt(SNR_sim/5));
elseif ModOrd==64
    ber_teor=4/6*(1-1/sqrt(ModOrd))*qfunc(sqrt(3/(ModOrd-1)*SNR));
    ber_teor_sim=4/6*(1-1/sqrt(ModOrd))*qfunc(sqrt(3/(ModOrd-1)*SNR_sim));
else
